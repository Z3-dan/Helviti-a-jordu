...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Start()
    {
        // Sækja rigidbody component og anim
    ...
    {
        // Ef leikmaður snertir powerup þáeyðist það og kraftar hanns hækka
        if (other.gameObject.tag == "Powerup")
        {
            fireballController.damageDealt++;
    ...
    void Update()
    {
        ...
        Vector3 moveRotationLeft = -Vector3.left * Input.GetAxisRaw("LeftJoystickHorizontal") + Vector3.forward * Input.GetAxisRaw("LeftJoystickVertical");

        //checkar hvort hann ætti að nota hægri eða vinstri stickið til að snúa spilaranum


          if (moveRotationRight.sqrMagnitude > 0.1f)
          {
          ...
          else if (moveRotationLeft.sqrMagnitude > 0.1f)
          {
